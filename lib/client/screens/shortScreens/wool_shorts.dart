...
class WoolQualityShorts extends StatefulWidget {
  const WoolQualityShorts({Key? key}) : super(key: key);

  @override
  _WoolQualityShortsState createState() => _WoolQualityShortsState();
}

class _WoolQualityShortsState extends State<WoolQualityShorts> {
